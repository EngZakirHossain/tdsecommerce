...
class HomeController extends Controller
{
    public function home(){
        ...
        ->get();
        //slider
        $banners = Banner::where('banner_type',1)->latest('id')->limit(3)
        ->select(['id','banner_name','slug','image',])
        ->get();
        ...
        return view('frontend.pages.home',compact('testimonials','products','banners'));
    }
