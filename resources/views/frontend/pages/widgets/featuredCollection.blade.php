                            ...
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/9.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/1.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/10.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/2.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/11.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/3.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/14.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/4.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/15.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/5.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/16.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/6.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/17.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/7.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/19.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/furniture/8.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/11.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/1.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/22.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/2.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/23.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/3.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/26.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/4.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/27.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/5.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/29.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/6.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/17.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/7.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/18.jpg"
                                        alt="product-img">
                                    <img class="primary-img"
                                        src="{{ asset('assets/frontend') }}/img/products/bags/8.jpg"
                                        alt="product-img">
                                </a>
