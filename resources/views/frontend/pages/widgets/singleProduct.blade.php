                                 ...
                                 <div class="img-large-slider common-slider"
                                     ...
                                     @foreach ($product->productImages as $image)
                                         <div class="img-large-wrapper">
                                             <a href="{{ asset('storage/uploads/products/') }}/{{ $product->id }}/{{ $image->product_multiple_image }}"
                                                 data-fancybox="gallery">
                                                 <img src="{{ asset('storage/uploads/products/') }}/{{ $product->id }}/{{ $image->product_multiple_image }}"
                                                     alt="img" onerror="this.src='{{ asset('assets/backend/images/product/product.png') }}'">
                                             </a>
                                         </div>
                                     @endforeach
                                 </div>
                 ...
                 <div class="tab-content product-tab-content">
                         ...
                         <div class="row">
                             <div class="col-lg-7 col-md-12 col-12">
                                 <div class="desc-content">
                                     <p class="text_16 mb-4">{{ $product->product_details }}</p>
                                 </div>
                             </div>
                         </div>
                     </div>
                     <div id="pshipping" class="tab-pane fade">
                         <div class="desc-content">
                             ...
                             <p class="text_16 mb-4">{{ $product->product_shippingDetails }}</p>
                     ...
                     <div id="pstyle" class="tab-pane fade">
                         <div class="desc-content">
                             ...
                             <p class="text_16 mb-4">Please also bear in mind that shipping goods back and forth generates
                                 greenhouse gases that are accelerating climate change. We encourage you to choose your
                                 items carefully to avoid unnecessary return shipments.</p>
                             <p class="text_16 mb-4">You have to pay for return shipping if you want to exchange your
                                 product for another size or the package is returned because it has not been picked up at
                                 the post office.</p>
                         </div>
                     </div>
