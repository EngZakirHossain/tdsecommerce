                ...
                <div class="row flex-row-reverse">
                    ...
                    <div class="col-lg-9 col-md-12 col-12">
                        <div class="filter-sort-wrapper d-flex justify-content-between flex-wrap">
                            <div class="collection-title-wrap d-flex align-items-end">
                                ...
                                <p class="collection-counter text_16 mb-0 ms-2">({{ count($allProducts) }}items)</p>
                            </div>
                                        ...
                                        <div class="product-card">
                                            <div class="product-card-img">
                                                ...
                                                <div class="product-badge">
                                                    <span class="badge-label badge-percentage rounded">New</span>
                                                </div>

                                                <div
                                                    class="product-card-action product-card-action-2 justify-content-center">
                                                    <a href="#quickview-modal{{ $product->slug }}"
                            ...
                            <nav>
                                @if ($allProducts->hasPages())
                                    <ul class="pagination m-0 d-flex align-items-center">
                                        ...
                                        @if ($allProducts->onFirstPage())
                                            <li class="item disabled">
                                                <a type="button"class="link"
                                                    href="{{ $allProducts->previousPageUrl() }}">
                                        ...
                                        {{ 'Page ' . $allProducts->currentPage() . '  of  ' . $allProducts->lastPage() }}
                    ...
                    <div class="col-lg-3 col-md-12 col-12">
                        <div class="collection-filter filter-drawer">
                            ...
                            <div class="filter-widget">
                                <a href="product.html">
                                    <img class="rounded" src="{{ asset('assets/frontend') }}/img/banner/collection.jpg"
                                        alt="img">
                                </a>
                            </div>
                        </div>
