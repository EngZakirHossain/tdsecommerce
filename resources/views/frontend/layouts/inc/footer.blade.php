                       ...
                       <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                           <div class="footer-widget-inner">
                               ...
                               <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                   ...
                                   <li class="footer-menu-item"><a href="collection-left-sidebar.html">Furniture</a>
                                   </li>
                                   <li class="footer-menu-item"><a href="collection-left-sidebar.html">Sofa</a>
                                   </li>
                                   <li class="footer-menu-item"><a href="collection-left-sidebar.html">Chair</a>
                                   </li>
                               </ul>
                           </div>
                       </div>
