...
@section('admin_content')
    <form action="{{ route('admin.testimonial.update', $testimonial->client_name_slug) }}" method="POST"
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Update New Testimonial</h4>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea id="textarea" name="client_message" class="form-control" rows="3" placeholder="Enter Client Message">{{ $testimonial->client_message }}</textarea>
                        </div>
                        <div class="form-check mt-3">
                            <input class="form-check form-switch " @if ($testimonial->is_active) checked @endif
                                name="is_active" type="checkbox" id="switch3" switch="bool">
