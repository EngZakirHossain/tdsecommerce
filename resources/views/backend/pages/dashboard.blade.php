                        ...
                        <table class="table table-hover table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset('assets/backend') }}/images/users/user-4.jpg"
                                                alt="" class="avatar-xs rounded-circle me-2">
                                            Robert Sitton
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset('assets/backend') }}/images/users/user-5.jpg"
                                                alt="" class="avatar-xs rounded-circle me-2">
                                            Alberto Jackson
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <img src="{{ asset('assets/backend') }}/images/users/user-6.jpg"
                                                alt="" class="avatar-xs rounded-circle me-2">
                                            David Sanchez
                                        </div>
                                    </td>
