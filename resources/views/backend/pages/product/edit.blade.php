                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="product_sku" name="thresholdconfig"
                                        ...
                                        placeholder="Enter Product Sku" value="{{ $product->product_sku }}">
                                    @error('product_sku')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="number" name="product_stock" placeholder="Enter Product Stock"
                                        ...
                                        id="alloptions" min="1" value="{{ $product->product_stock }}">
                                    @error('product_stock')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="number" name="product_alertQuantity" name="thresholdconfig"
                                        ...
                                        value="{{ $product->product_alertQuantity }}">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="number" name="product_price" placeholder="Enter Product Price"
                                        ...
                                        id="alloptions" min="0" value="{{ $product->product_price }}">
                                    @error('product_price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea id="textarea" name="product_shippingDetails" class="form-control" rows="3"
                                placeholder="Enter Product Shipping Details">{{ $product->product_shippingDetails }}</textarea>
                        </div>
                        <div class="form-check mt-3">
                            <input class="form-check form-switch" name="is_active" type="checkbox" id="switch3"
                                switch="bool" @if ($product->is_active) checked @endif>
                ...
                <div class="card">
                    <div class="card-body ">
                        <div class="mb-5">
                            ...
                            <input type="file" class="form-control dropify" name="product_thumbnail"
                                data-default-file="{{ asset('storage/uploads/products/thumbnail') }}/{{ $product->product_thumbnail }}">
