...
@section('add_button')
    <div class="col-md-4">
        <div class="float-end d-none d-md-block">
            <div class="dropdown">
                <a class="btn btn-primary" href="{{ route('admin.banner.create') }}"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group me-2 mb-2 mb-sm-0">
                                        <a href="{{ route('admin.banner.edit', $banner->slug) }}" type="button"
                                            class="btn btn-primary waves-effect waves-light ">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form method="POST"
                                            action="{{ route('admin.banner.destroy', $banner->slug) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
